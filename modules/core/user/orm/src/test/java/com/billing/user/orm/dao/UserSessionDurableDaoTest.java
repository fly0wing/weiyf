...
public class UserSessionDurableDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(UserSessionDurableDaoTest.class);
    @Autowired
    UserSessionDurableDao userSessionDurableDao;
