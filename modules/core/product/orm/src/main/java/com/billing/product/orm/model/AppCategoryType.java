...
public class AppCategoryType implements Serializable {
     ...
     */
    private String appCategoryTypeId;
    /**
	...
	public AppCategoryType(
		String appCategoryTypeId
	) {
		this.appCategoryTypeId = appCategoryTypeId;
	}

	public void setAppCategoryTypeId(String value) {
		this.appCategoryTypeId = value;
	}

	public String getAppCategoryTypeId() {
    ...
    public int hashCode() {
        return new HashCodeBuilder()
            .append(getAppCategoryTypeId())
            .toHashCode();
    }

    public boolean equals(Object obj) {
        if(obj instanceof AppCategoryType == false) return false;
        if(this == obj) return true;
        AppCategoryType other = (AppCategoryType)obj;
        return new EqualsBuilder()
            .append(getAppCategoryTypeId(),other.getAppCategoryTypeId())
            .isEquals();
    }
