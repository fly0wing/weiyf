...
public class PartyContentTypeDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(PartyContentTypeDaoTest.class);
    @Autowired
    PartyContentTypeDao partyContentTypeDao;
