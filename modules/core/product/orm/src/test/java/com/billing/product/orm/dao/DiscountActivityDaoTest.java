...
public class DiscountActivityDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(DiscountActivityDaoTest.class);
    @Autowired
    DiscountActivityDao discountActivityDao;
