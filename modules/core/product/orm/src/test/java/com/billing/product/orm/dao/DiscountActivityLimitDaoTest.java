...
public class DiscountActivityLimitDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(DiscountActivityLimitDaoTest.class);
    @Autowired
    DiscountActivityLimitDao discountActivityLimitDao;
