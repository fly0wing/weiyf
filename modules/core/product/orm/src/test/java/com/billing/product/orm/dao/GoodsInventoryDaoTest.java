...
public class GoodsInventoryDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(GoodsInventoryDaoTest.class);
    @Autowired
    GoodsInventoryDao goodsInventoryDao;
