...
public class GoodsDiscountDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(GoodsDiscountDaoTest.class);
    @Autowired
    GoodsDiscountDao goodsDiscountDao;
