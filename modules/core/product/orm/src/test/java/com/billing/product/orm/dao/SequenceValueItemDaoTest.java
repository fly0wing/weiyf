...
public class SequenceValueItemDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(SequenceValueItemDaoTest.class);
    @Autowired
    SequenceValueItemDao sequenceValueItemDao;
