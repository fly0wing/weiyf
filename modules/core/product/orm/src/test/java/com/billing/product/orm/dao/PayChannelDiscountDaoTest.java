...
public class PayChannelDiscountDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(PayChannelDiscountDaoTest.class);
    @Autowired
    PayChannelDiscountDao payChannelDiscountDao;
