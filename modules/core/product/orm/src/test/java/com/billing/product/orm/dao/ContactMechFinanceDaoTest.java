...
public class ContactMechFinanceDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(ContactMechFinanceDaoTest.class);
    @Autowired
    ContactMechFinanceDao contactMechFinanceDao;
