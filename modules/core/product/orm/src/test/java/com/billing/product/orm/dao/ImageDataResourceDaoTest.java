...
public class ImageDataResourceDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(ImageDataResourceDaoTest.class);
    @Autowired
    ImageDataResourceDao imageDataResourceDao;
