...
public class ContactMechTypeDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(ContactMechTypeDaoTest.class);
    @Autowired
    ContactMechTypeDao contactMechTypeDao;
