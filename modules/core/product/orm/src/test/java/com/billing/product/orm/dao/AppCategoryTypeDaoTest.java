...
public class AppCategoryTypeDaoTest {

    private static final Logger logger = LoggerFactory.getLogger(AppCategoryTypeDaoTest.class);
    @Autowired
    AppCategoryTypeDao appCategoryTypeDao;
